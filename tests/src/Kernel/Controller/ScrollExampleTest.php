...
use Drupal\bluecadet_ajax_content_example\Controller\ScrollExample;
use Drupal\Core\Render\RenderContext;
use Drupal\KernelTests\KernelTestBase;
use Symfony\Component\HttpFoundation\Request;

/**
 * Tests the ScrollExample controller.
 *
 * @group bluecadet_ajax_content
 */
class ScrollExampleTest extends KernelTestBase {
   ...
   *
   * @var \Drupal\bluecadet_ajax_content_example\Controller\ScrollExample
   */
  protected ScrollExample $controller;
  ...
  protected function setUp(): void {
    ...
    $this->controller = $this->container->get('class_resolver')
      ->getInstanceFromDefinition(ScrollExample::class);
  }
  ...
  public function testBuild(): void {
    ...
    $this->assertStringContainsString('data-ajax-scroll="/ajax-api/scroll-example"', $build['center-content']['#markup']);
